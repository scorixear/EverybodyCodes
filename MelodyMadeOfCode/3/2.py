...
class Node:
    ...
    def addNode(self, other: "Node"):
        if self.left is None:
            if (
                self.leftSocket[0] == other.plug[0]
                or self.leftSocket[1] == other.plug[1]
            ):
                if (
                    self.leftSocket[0] == other.plug[0]
                    and self.leftSocket[1] == other.plug[1]
                ):
                ...
                if (
                    self.rightSocket[0] == other.plug[0]
                    or self.rightSocket[1] == other.plug[1]
                ):
                    if (
                        self.rightSocket[0] == other.plug[0]
                        and self.rightSocket[1] == other.plug[1]
                    ):
